...
The current release is **0.0.5** (preview). Linux packages are on [GitHub Releases](https://github.com/bzync/nextsql/releases/tag/v0.0.5). On Windows, run them inside [WSL 2](docs/install.md#windows-wsl-2).
...
Pre-built Linux installers (`.deb`, `.tar.gz`, `.run`) are on the [v0.0.5 release](https://github.com/bzync/nextsql/releases/tag/v0.0.5). Native Windows is not supported; on Windows, run NextSQL inside [WSL 2](docs/install.md#windows-wsl-2).
...
- **[Changelog](CHANGELOG.md)** — what shipped in 0.0.5
