...
| Audit viewer | Developer operations scope | yes | shared status renderer + real-browser verified→tampered refresh/suspect-row retention/reopen/axe + existing Security route integration | no |
