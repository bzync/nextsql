...
| Audit viewer | Developer operations scope | yes | shared status renderer + real-browser verified→tampered refresh/suspect-row retention/reopen/axe; dark audit-failure text has an asserted 7.23:1 contrast ratio against its raised surface + existing Security route integration | no |
