...
| Runtime/container | Production profile preflight, lifecycle controls, Docker entrypoint tests | macOS installer execution and recovery-key flow remain blocked (native Windows de-scoped in log #290) | HIGH | `internal/config/production.go`, `internal/dockerentry`, `TODO.md` |
