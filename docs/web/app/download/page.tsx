    ...
    <main id="content">
      <section className="border-b border-line">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-5 sm:py-16">
          ...
          <h1 className="mt-3 max-w-2xl text-[2.05rem] font-semibold tracking-[-0.028em] sm:text-[2.4rem]">
          ...
          {latest ? (
            <div className="mt-8 rounded-md border border-line p-5 sm:p-6">
      ...
      <section>
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-5 sm:py-16">
          <h2 className="text-xl font-semibold tracking-[-0.022em] sm:text-2xl">All versions</h2>
          {releases.length === 0 ? (
