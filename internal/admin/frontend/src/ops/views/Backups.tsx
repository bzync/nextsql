      ...
      {data ? (
        <>
          <Alert variant="info" title="Scope">
            Backups are written to the server's configured <InlineCode>backup_dir</InlineCode>
            ...
            <CardBody>
              <Stack gap="sm">
                <Text variant="muted" size="sm">
                  ...
                  the server's <InlineCode>backup_dir</InlineCode>. May take a while for a
                  large database.
                </Text>
          ...
          <Stack gap="xs">
            ...
            {rows.length === 0 ? (
              <Text variant="muted" size="sm">
                No backups (or no <InlineCode>backup_dir</InlineCode> configured on the
                server).
              </Text>
            ) : (
