...
func Catalog() []Spec {
	return []Spec{
		...
		{Family: FamilyCatalog, Magic: "NSCT", Current: 4, MinReadable: 1, MaxReadable: 4, Notes: "table descriptors; v1 empty FKs, v2 foreign keys, v3 CDC image policy, v4 partition metadata"},
